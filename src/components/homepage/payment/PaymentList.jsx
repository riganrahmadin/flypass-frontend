                    ...
                    <div className="payment-item card p-3 gap-4">
                        <div>
                            ...
                            <div className="d-flex gap-3">
                                ...
                                <div
                                  className={`border ${showCheck.flightPay && 'border-primary border-2'} p-2 rounded position-relative payment-item-light payment-item-name`}
                      ...
                      21/01/2023 05:00 PM</p>
                                ...
                                <div className="mt-4 mt-md-2">
                                    ...
                                    <div className="d-flex justify-content-end mt-3">
                                        <div
                                          className="btn btn-primary shadow btn-send"
