...
class Form extends Component {
    ...
    render() {
        ...
        const departureAirports = this.state.airports.filter((airports) => airports.name.toLowerCase().includes(departure));

        const destination = this.props.flight.destination.toLowerCase();
        const arrivalAirports = this.state.airports.filter((airports) => airports.name.toLowerCase().includes(destination));
            ...
            >
                <ul>
                    ...
                    <li>
                        ...
                        <select
                            name="trip" id="trip" className="trip"
                            onChange={(event) => this.props.inputSearchFlightDispatch(event)}
                    ...
                    <li>
                        ...
                        <select
                            name="passenger" id="passenger" onChange={(event) => this.props.inputSearchFlightDispatch(event)}
                            onClick={() => this.hideAllList()}
                            required style={{ height: '45px' }}
                        >
