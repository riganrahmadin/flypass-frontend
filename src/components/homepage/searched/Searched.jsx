...
class Searched extends Component {
    ...
    render() {
        return (
            <section className="container m-auto card pt-3 pb-3 flight-result searched">
                    ...
                    && (
                        <>
                            ...
                            {this.props.flights.map((flight) => (
                                <div className="card search_result p-0">
                                    <div className="flight-name bg">
                                        <div><img src={flight.Airline.image} alt="garuda logo" width={100} /></div>
                                        {/* <span>{flight.Airline.name}</span> */}
                                    </div>
                                    <div className="flight-duration-ring bg">
                                        <div className="cgk-time">
                                            {/* 20010704T120854 */}
                                            <div className="time">{flight.departureTime.slice(0, -3)}</div>
                                            <div className="cgk">{flight.departureAirport.iata}</div>
                                        </div>
                                        ...
                                        <div className="sn-time">
                                            ...
                                            <div className="time">{flight.arrivalTime.slice(0, -3)}</div>
                                            <div className="sn">{flight.arrivalAirport.iata}</div>
                                        </div>
                                    </div>
                                    <div className="bg flight-service">
                                        <div className="service-label">Service:</div>
                                        <div>Bagasi 30kg, Makan, Hiburan</div>
                                    </div>
                                    <div className="bg flight-price">
                                        <div className="price"><span className="value">Rp {flight.price}</span>/org</div>
