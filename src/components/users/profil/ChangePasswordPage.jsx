                        ...
                        <form onSubmit={(e) => submit(e)} className="d-md-flex gap-md-5">
                            <div className="col">
                                <div className="mb-0">
                                    ...
                                    <input onChange={(e) => handle(e)} value={data.olddpassword} type="password" className="form-control mt-0" id="olddpassword" placeholder="old password" />
                                </div>
                            </div>
                            <div className="col">
                                <div className="mb-0">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">New Password</label>
                                    <input onChange={(e) => handle(e)} value={data.newpassword} type="password" className="form-control mt-0" id="newpassword" placeholder="new password" />
                                </div>
                            </div>
                            <div className="col">
                                <div className="mb-0">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">New Confirmation Password</label>
                                    <input onChange={(e) => handle(e)} value={data.Newconfirmpassword} type="password" className="form-control mt-0" id="Newconfirmpassword" placeholder="new confirm password" />
                                </div>
