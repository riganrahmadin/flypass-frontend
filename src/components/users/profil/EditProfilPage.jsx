                        ...
                        <form onSubmit={(e) => submit(e)} className="d-md-flex gap-md-5">
                            <div className="col">
                                <div className="mb-0">
                                    ...
                                    <input onChange={(e) => handle(e)} value={data.name} type="text" className="form-control mt-0" id="name" placeholder="your name" />
                                </div>
                                <div className="mb-0">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Email</label>
                                    <input onChange={(e) => handle(e)} value={data.email} type="email" className="form-control mt-0" id="email" placeholder="name@example.com" />
                                </div>
                                <div className="mb-0">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Phone</label>
                                    <input onChange={(e) => handle(e)} value={data.phone} type="text" className="form-control mt-0" id="phone" placeholder="0812345667" />
                                </div>
                                <div className="mb-0">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Gender</label>
                                    <select onChange={(e) => handle(e)} id="gender" value={data.gender} className="form-select form-select-lg" aria-label=".form-select-lg example">
                                        {data.gender == 'Male'
                                            ? (
                                                <>
                            ...
                            <div className="col">
                                <div className="mb-0">
                                    ...
                                    <input onChange={(e) => handle(e)} value={data.birthDate} type="date" className="form-control mt-0" id="birthDate" placeholder="xx-xx-xxxx" />
                                </div>
                                <div>
                                ...
                                <div className="mb-0">
                                    ...
                                    <input onChange={(e) => handle(e)} type="file" className="form-control mt-0" id="image" placeholder="name@example.com" />
                                </div>
